...
const std::list<std::string> k_H5GroupPaths = {"EMData/EBSDmaster", "EMheader/EBSDmaster", "NMLparameters/EBSDMasterNameList", "NMLparameters/BetheList"};
} // namespace

/**
 * @brief main This test will check that all groups exist and have the same structure in both the test and exemplary files
 * @param argc
 * @param argv
 * @return
 */
